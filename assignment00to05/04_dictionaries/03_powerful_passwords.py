# 03_powerful_passwords.py by merchantsons
...
def main():
    ...
    print(login("example@gmail.com", stored_logins, "word"))  # Should print True
    print(login("example@gmail.com", stored_logins, "password"))  # Should print False
